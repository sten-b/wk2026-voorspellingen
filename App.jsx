...
const DARK_HORSES = [
  { name:"Gilberto Mora", stats:[{v:"17",nl:"jaar (jongste)",en:"years (youngest)"},{v:"Gold Cup",nl:"2025 winnaar",en:"2025 winner"},{v:"Real Madrid",nl:"interesse",en:"interest"}], value:"€18m", clubLogo:"https://assets.football-logos.cc/logos/mexico/700x700/tijuana.png",
    team:"Mexico", pos:{nl:"Aanvallende middenvelder",en:"Attacking midfielder"}, age:17, flag:"🇲🇽",
    club:"Tijuana",
    why:{nl:"Door content writers (bet365, Al Jazeera, ESPN) unaniem getipt als breakout-ster. Mora is met 17 de jongste speler van het toernooi: hij werd de jongste Mexicaanse international ooit en won de Gold Cup 2025. Real Madrid en Barcelona volgen hem op de voet. Op eigen bodem, op hoogte, kan hij de revelatie van het WK worden.",en:"Unanimously tipped by content writers (bet365, Al Jazeera, ESPN) as a breakout star. At 17 the youngest player at the tournament: the youngest-ever Mexico international, a 2025 Gold Cup winner. Real Madrid and Barcelona are tracking him closely. On home soil, at altitude, he could be the revelation of the World Cup."} },
  { name:"Kenan Yildiz", stats:[{v:"16",nl:"goal involvements",en:"goal involvements"},{v:"33",nl:"Serie A duels",en:"Serie A apps"},{v:"2-2",nl:"vs Spanje",en:"vs Spain"}], value:"€75m", clubLogo:"https://assets.football-logos.cc/logos/italy/700x700/juventus.png",
    team:"Turkey", pos:{nl:"Aanvallende middenvelder",en:"Attacking midfielder"}, age:21, flag:"🇹🇷",
    club:"Juventus",
    why:{nl:"Bleacher Report en Al Jazeera noemen Yildiz als dé Turkse breakout-kandidaat — getipt als mogelijke opvolger van Messi. Bij Juventus leverde de 21-jarige 16 goal involvements in 33 competitieduels. In de laatste kwalificatiewedstrijd hield Turkije met hem Europees kampioen Spanje op 2-2. Zijn dribbels maken hem een hoogtepunt voor de highlight reels.",en:"Bleacher Report and Al Jazeera name Yildiz as Turkey's breakout candidate — tipped as a possible Messi successor. At Juventus the 21-year-old recorded 16 goal involvements in 33 league games. In Turkey's final qualifier they held European champions Spain to 2-2 with him pulling the strings. His dribbling makes him a highlight-reel staple."} },
  { name:"Antonio Nusa", stats:[{v:"7",nl:"goal contributions",en:"goal contributions"},{v:"#1",nl:"dribbels (vleugel)",en:"dribbles (wide)"},{v:"Naast",nl:"Haaland",en:"alongside Haaland"}], value:"€45m", clubLogo:"https://assets.football-logos.cc/logos/germany/700x700/rb-leipzig.png",
    team:"Norway", pos:{nl:"Linksbuiten",en:"Left winger"}, age:20, flag:"🇳🇴",
    club:"RB Leipzig",
    why:{nl:"RotoWire en Bleacher Report tippen Nusa als breakout-ster. De 20-jarige had bij RB Leipzig zeven goal contributions en het hoogste dribbelvolume van alle vleugelspelers in de Bundesliga. Met Haaland die altijd dubbel gedekt wordt, krijgt Nusa de ruimte en de vrijheid om chaos te stichten — zijn eigen woorden over zijn rolmodel Neymar.",en:"RotoWire and Bleacher Report tip Nusa as a breakout star. The 20-year-old had seven goal contributions at RB Leipzig and the highest dribbling volume of any wide player in the Bundesliga. With Haaland double-marked every match, Nusa gets the space and licence to create chaos — his own word, citing role model Neymar."} },
  { name:"Nico Paz", stats:[{v:"12",nl:"goals",en:"goals"},{v:"7",nl:"assists",en:"assists"},{v:"Como",nl:"naar CL",en:"to CL"}], value:"€65m", clubLogo:"https://assets.football-logos.cc/logos/italy/700x700/como.png",
    team:"Argentina", pos:{nl:"Aanvallende middenvelder",en:"Attacking midfielder"}, age:21, flag:"🇦🇷",
    club:"Como",
    why:{nl:"RotoWire en Al Jazeera noemen Paz als breakout-speler. De 21-jarige was met 12 goals en 7 assists de motor van Como, dat onder zijn impuls naar de Champions League promoveerde. Geboren in Spanje koos hij voor Argentinië en vecht hij om een rol achter Messi. Zijn vrije trappen en sleutelpasses geven Scaloni een frisse creatieve optie.",en:"RotoWire and Al Jazeera name Paz as a breakout player. The 21-year-old was Como's engine with 12 goals and 7 assists, driving them to Champions League qualification. Born in Spain, he chose Argentina and is fighting for a role behind Messi. His set pieces and key passes give Scaloni a fresh creative option."} },
  { name:"Ibrahim Maza", stats:[{v:"3",nl:"goals",en:"goals"},{v:"4",nl:"assists",en:"assists"},{v:"40+",nl:"clubduels",en:"club apps"}], value:"€30m", clubLogo:"https://assets.football-logos.cc/logos/germany/700x700/bayer-leverkusen.png",
    team:"Algeria", pos:{nl:"Middenvelder",en:"Midfielder"}, age:20, flag:"🇩🇿",
    club:"Bayer Leverkusen",
    why:{nl:"Door bet365, RotoWire en BBC-analisten getipt. Maza, opgeleid in Duitsland tot onder-20 maar kiezend voor Algerije, brak door bij Bayer Leverkusen: 3 goals en 4 assists in de Bundesliga, plus twee assists in de Champions League. Bijgenaamd 'Mazadona' om zijn techniek. Op zijn 20e al meer dan 40 clubduels en 15 caps.",en:"Tipped by bet365, RotoWire and BBC analysts. Maza, German-developed to under-20 level but choosing Algeria, broke through at Bayer Leverkusen: 3 goals and 4 assists in the Bundesliga plus two Champions League assists. Nicknamed 'Mazadona' for his skill. At 20 already 40+ club games and 15 caps."} },
  { name:"Endrick", stats:[{v:"3",nl:"goals",en:"goals"},{v:"4",nl:"assists",en:"assists"},{v:"Lyon",nl:"heropleving",en:"Lyon revival"}], value:"€40m", clubLogo:"https://assets.football-logos.cc/logos/france/700x700/olympique-lyon.png",
    team:"Brazil", pos:{nl:"Spits",en:"Striker"}, age:19, flag:"🇧🇷",
    club:"Lyon (huur)",
    why:{nl:"Door ESPN genoemd als talent om op te letten. Na weinig speeltijd bij Real Madrid bloeide de 19-jarige op tijdens zijn huurperiode bij Lyon: 3 goals en 4 assists en duidelijk speelritme richting het WK. Bij een Brazilië dat Rodrygo (ACL) en Estêvão (hamstring) mist, kan Endrick onverwacht minuten en momenten pakken.",en:"Named by ESPN as a talent to watch. After limited minutes at Real Madrid, the 19-year-old came alive on loan at Lyon: 3 goals and 4 assists and real rhythm heading into the World Cup. With Brazil missing Rodrygo (ACL) and Estevao (hamstring), Endrick could grab unexpected minutes and moments."} },
  { name:"Crysencio Summerville", stats:[{v:"5",nl:"goals",en:"goals"},{v:"2",nl:"assists",en:"assists"},{v:"Joker",nl:"Oranje",en:"Dutch joker"}], value:"€28m", clubLogo:"https://assets.football-logos.cc/logos/england/700x700/west-ham-united.png",
    team:"Netherlands", pos:{nl:"Linksbuiten",en:"Left winger"}, age:24, flag:"🇳🇱",
    club:"West Ham United",
    why:{nl:"Een wildcard in Koeman's selectie: explosief, direct en onvoorspelbaar één-op-één. Summerville kwam terug van een hamstringoperatie en sloot 25/26 af met 5 goals en 2 assists in een zwaar West Ham-seizoen. In een Oranje dat vooral controle zoekt, is hij precies het verschilmakende invaltype dat een vastgelopen wedstrijd kan openbreken.",en:"A wildcard in Koeman's squad: explosive, direct and unpredictable one-on-one. Summerville returned from hamstring surgery and ended 25/26 with 5 goals and 2 assists in a tough West Ham season. In a Dutch side built around control, he is exactly the difference-making substitute who can break open a stalled match."} },
  { name:"Elliot Anderson", stats:[{v:"Vaste",nl:"basisplek",en:"guaranteed starter"},{v:"7",nl:"caps",en:"caps"},{v:"Box-to-box",nl:"motor",en:"engine"}], value:"€45m", clubLogo:"https://assets.football-logos.cc/logos/england/700x700/nottingham-forest.png",
    team:"England", pos:{nl:"Middenvelder",en:"Midfielder"}, age:23, flag:"🏴󠁧󠁢󠁥󠁮󠁧󠁿",
    club:"Nottingham Forest",
    why:{nl:"Bleacher Report noemt Anderson als breakout-ster: in slechts zeven interlands dwong hij een vaste basisplaats af bij Tuchels Engeland. Zijn box-to-box energie, balrecuperatie en progressieve passing maken hem het onvermoeibare evenwicht dat de creatievelingen laat schitteren — mogelijk het nieuwe sjabloon voor een Premier League-middenvelder.",en:"Bleacher Report names Anderson as a breakout star: in just seven caps he earned a guaranteed starting spot in Tuchel's England. His box-to-box energy, ball recovery and progressive passing make him the tireless balance that lets the creators shine — potentially the new template for a Premier League midfielder."} },
  { name:"Yan Diomande", stats:[{v:"12",nl:"goals",en:"goals"},{v:"8",nl:"assists",en:"assists"},{v:"19",nl:"jaar",en:"years"}], value:"€20m", clubLogo:"https://assets.football-logos.cc/logos/germany/700x700/rb-leipzig.png",
    team:"Ivory Coast", pos:{nl:"Vleugelspeler",en:"Winger"}, age:19, flag:"🇨🇮",
    club:"RB Leipzig",
    why:{nl:"Een door analisten breed genoemde breakout-pick. Diomande domineerde voor RB Leipzig met atletisme, interceptievermogen en doelgevaar vanuit de tweede lijn. Ivoorkust is AFCON-kampioen 2024 en met Haller en Adingra heeft hij buitenspelers die zijn runs belonen. Brak door met 12 goals en 8 assists — een doorbraakseizoen voor de 19-jarige.",en:"A widely cited breakout pick. Diomande dominated for RB Leipzig with athleticism, interception ability and late runs into the box. Ivory Coast are AFCON 2024 champions and with Haller and Adingra he has wide players who reward his runs. Broke through with 12 goals and 8 assists — a breakout season for the 19-year-old."} },
  { name:"Takefusa Kubo", stats:[{v:"Copa del Rey",nl:"2026",en:"2026"},{v:"Elite",nl:"dribbels",en:"dribbling"},{v:"Creatief",nl:"aanvoerder",en:"creative leader"}], value:"€31m", clubLogo:"https://assets.football-logos.cc/logos/spain/700x700/real-sociedad.png",
    team:"Japan", pos:{nl:"Rechtsmiddenvelder",en:"Right midfielder"}, age:24, flag:"🇯🇵",
    club:"Real Sociedad",
    why:{nl:"Japan's meest technisch begaafde speler en, met Mitoma afwezig, de creatieve aanvoerder van de aanval. Bij Real Sociedad bewees Kubo consistent te zijn in La Liga: zijn dribbelstatistieken en schoten van buiten de zestien zijn elite. Kroonde zijn seizoen met winst van de Copa del Rey 2026. Als Japan een grote ploeg verslaat, is Kubo waarschijnlijk de man.",en:"Japan's most technically gifted player and, with Mitoma absent, the creative leader of the attack. At Real Sociedad, Kubo proved consistent in La Liga: his dribbling stats and long-range shooting are elite. Capped his season by winning the 2026 Copa del Rey. If Japan beat a major side, Kubo is likely the difference-maker."} },
];
...
// Top 30 WC2026 players by transfer value (CIES/Transfermarkt). Stats: 2025/26 domestic league.
...
function AppLoader({onDone}){
  ...
  return(
    <div style={{position:"fixed",inset:0,zIndex:9999,
      ...
      {/* STATIC LION — same column layout (so it lands exactly where the ring's lion was), but only
          the lion is visible. It stays perfectly still while everything else swirls away, then
          fades out last. */}
      <div style={{position:"absolute",display:"flex",flexDirection:"column",alignItems:"center",gap:13,
        opacity:shown?(lionGone?0:1):0,
        ...
        <div style={{display:"flex",flexDirection:"column",alignItems:"center",gap:2,marginTop:6,visibility:"hidden"}}>
          ...
          <span style={{fontSize:FS.display,fontWeight:WEIGHT.bold,letterSpacing:2}}>WK2026</span>
          <div style={{display:"flex",flexDirection:"column",alignItems:"center",gap:2,marginTop:14}}>
            <span style={{fontSize:FS.small,fontWeight:WEIGHT.bold,letterSpacing:3}}>Data-driven</span>
            <span style={{fontSize:FS.body,fontWeight:WEIGHT.bold,letterSpacing:2}}>Voorspellingen</span>
          </div>
        </div>
      </div>
    </div>
