...
const MODEL_DATA={
  "Spain":{elo:2155,eloN:94.4,svN:90.2,form:68.7,exp:67.5,coach:72,xg:2.909,xgc:0.879,formN:79.5,formScore:0.127},
  "Argentina":{elo:2114,eloN:89.2,svN:89.2,form:63.8,exp:100.0,coach:96,xg:2.141,xgc:0.346,formN:75.2,formScore:0.104},
  "France":{elo:2062,eloN:82.8,svN:98.2,form:65.7,exp:89.6,coach:90,xg:2.485,xgc:0.965,formN:84.6,formScore:0.155},
  "England":{elo:2021,eloN:77.6,svN:100.0,form:64.5,exp:87.8,coach:88,xg:2.394,xgc:0.24,formN:94.9,formScore:0.21},
  "Brazil":{elo:1991,eloN:73.9,svN:96.3,form:57.1,exp:75.9,coach:98,xg:1.898,xgc:0.784,formN:37.6,formScore:-0.1},
  "Portugal":{elo:1986,eloN:73.2,svN:93.5,form:62.2,exp:60.4,coach:70,xg:2.909,xgc:1.137,formN:66.7,formScore:0.057},
  "Colombia":{elo:1977,eloN:72.1,svN:75.0,form:50.7,exp:64.8,coach:46,xg:2.201,xgc:1.08,formN:35.0,formScore:-0.114},
  "Netherlands":{elo:1944,eloN:68.0,svN:85.7,form:60.3,exp:45.2,coach:68,xg:2.886,xgc:0.733,formN:71.8,formScore:0.085},
  "Ecuador":{elo:1938,eloN:67.2,svN:61.9,form:56.2,exp:40.7,coach:38,xg:0.635,xgc:0.324,formN:31.6,formScore:-0.132},
  "Germany":{elo:1932,eloN:66.5,svN:89.9,form:50.3,exp:46.5,coach:74,xg:2.44,xgc:0.834,formN:76.9,formScore:0.113},
  "Norway":{elo:1914,eloN:64.2,svN:81.6,form:67.0,exp:0.0,coach:44,xg:3.654,xgc:0.738,formN:97.4,formScore:0.224},
  "Croatia":{elo:1911,eloN:63.9,svN:69.0,form:53.9,exp:70.6,coach:66,xg:2.541,xgc:0.862,formN:79.5,formScore:0.127},
  "Turkey":{elo:1911,eloN:63.9,svN:79.2,form:56.0,exp:23.8,coach:50,xg:2.283,xgc:1.144,formN:75.6,formScore:0.106},
  "Japan":{elo:1906,eloN:63.2,svN:66.0,form:54.9,exp:49.1,coach:46,xg:1.648,xgc:0.478,formN:70.3,formScore:0.077},
  "Belgium":{elo:1893,eloN:61.6,svN:80.4,form:65.1,exp:57.7,coach:74,xg:3.565,xgc:0.807,formN:71.8,formScore:0.085},
  "Uruguay":{elo:1892,eloN:61.5,svN:74.7,form:33.3,exp:61.7,coach:82,xg:0.843,xgc:0.697,formN:22.2,formScore:-0.183},
  "Switzerland":{elo:1891,eloN:61.4,svN:65.8,form:64.2,exp:52.4,coach:48,xg:2.268,xgc:0.667,formN:66.7,formScore:0.057},
  "Mexico":{elo:1915,eloN:64.4,svN:54.0,form:53.5,exp:74.8,coach:64,xg:1.528,xgc:0.61,formN:56.4,formScore:0.002},
  "Senegal":{elo:1867,eloN:58.4,svN:77.0,form:52.4,exp:74.0,coach:50,xg:1.983,xgc:0.847,formN:68.7,formScore:0.069},
  "Paraguay":{elo:1833,eloN:54.1,svN:41.9,form:40.9,exp:29.4,coach:54,xg:1.213,xgc:0.811,formN:24.8,formScore:-0.169},
  "Austria":{elo:1830,eloN:53.8,svN:69.9,form:59.0,exp:23.0,coach:76,xg:2.46,xgc:0.59,formN:75.6,formScore:0.106},
  "Morocco":{elo:1827,eloN:53.4,svN:76.5,form:72.1,exp:76.8,coach:58,xg:2.11,xgc:0.345,formN:100.0,formScore:0.238},
  "Canada":{elo:1838,eloN:54.8,svN:56.5,form:51.7,exp:56.0,coach:52,xg:1.187,xgc:0.444,formN:53.8,formScore:-0.012},
  "Scotland":{elo:1782,eloN:47.8,svN:59.3,form:49.7,exp:13.2,coach:44,xg:2.255,xgc:1.13,formN:53.8,formScore:-0.012},
  "Australia":{elo:1777,eloN:47.1,svN:23.5,form:62.3,exp:36.2,coach:42,xg:1.614,xgc:0.778,formN:58.3,formScore:0.012},
  "Iran":{elo:1772,eloN:46.5,svN:28.3,form:47.2,exp:38.2,coach:40,xg:1.588,xgc:0.582,formN:55.8,formScore:-0.002},
  "Algeria":{elo:1760,eloN:45.0,svN:64.0,form:63.3,exp:36.9,coach:56,xg:1.883,xgc:0.49,formN:76.9,formScore:0.113},
  "South Korea":{elo:1758,eloN:44.8,svN:56.4,form:56.5,exp:39.8,coach:48,xg:1.837,xgc:0.819,formN:67.9,formScore:0.064},
  "Czechia":{elo:1740,eloN:42.5,svN:65.6,form:44.1,exp:22.2,coach:40,xg:2.178,xgc:1.21,formN:42.6,formScore:-0.073},
  "Panama":{elo:1730,eloN:41.2,svN:23.0,form:49.3,exp:49.3,coach:40,xg:1.751,xgc:1.285,formN:55.9,formScore:-0.001},
  "United States":{elo:1876,eloN:59.5,svN:64.8,form:36.3,exp:73.0,coach:78,xg:1.624,xgc:1.572,formN:48.7,formScore:-0.04},
  "Uzbekistan":{elo:1718,eloN:39.8,svN:35.3,form:51.7,exp:16.0,coach:64,xg:1.314,xgc:0.593,formN:49.4,formScore:-0.036},
  "Sweden":{elo:1712,eloN:39.0,svN:75.0,form:26.0,exp:23.6,coach:44,xg:1.47,xgc:1.851,formN:0.0,formScore:-0.304},
  "Egypt":{elo:1696,eloN:37.0,svN:47.1,form:43.5,exp:57.6,coach:42,xg:1.186,xgc:0.811,formN:64.6,formScore:0.046},
  "Ivory Coast":{elo:1695,eloN:36.9,svN:74.0,form:60.4,exp:47.3,coach:48,xg:2.454,xgc:0.773,formN:82.6,formScore:0.144},
  "Jordan":{elo:1685,eloN:35.6,svN:20.1,form:49.4,exp:24.0,coach:40,xg:1.874,xgc:1.507,formN:30.1,formScore:-0.141},
  "DR Congo":{elo:1661,eloN:32.6,svN:52.0,form:48.8,exp:40.0,coach:42,xg:1.153,xgc:0.462,formN:60.9,formScore:0.026},
  "Tunisia":{elo:1628,eloN:28.5,svN:29.6,form:34.7,exp:57.1,coach:38,xg:1.322,xgc:1.327,formN:52.8,formScore:-0.018},
  "Iraq":{elo:1618,eloN:27.3,svN:20.1,form:46.6,exp:13.3,coach:30,xg:1.109,xgc:0.732,formN:56.8,formScore:0.004},
  "Bosnia-Herzegovina":{elo:1595,eloN:24.4,svN:55.9,form:43.3,exp:0.0,coach:36,xg:1.816,xgc:0.986,formN:35.4,formScore:-0.112},
  "Cape Verde":{elo:1578,eloN:22.2,svN:40.8,form:46.2,exp:17.7,coach:30,xg:1.623,xgc:1.184,formN:52.8,formScore:-0.018},
  "Saudi Arabia":{elo:1569,eloN:21.1,svN:1.5,form:30.3,exp:34.5,coach:72,xg:1.147,xgc:1.131,formN:23.1,formScore:-0.179},
  "New Zealand":{elo:1562,eloN:20.2,svN:20.1,form:15,exp:0.0,coach:34,xg:0.906,xgc:1.601,formN:41.0,formScore:-0.081},
  "Haiti":{elo:1548,eloN:18.5,svN:23.0,form:40.7,exp:21.3,coach:40,xg:1.436,xgc:1.071,formN:33.3,formScore:-0.123},
  "South Africa":{elo:1528,eloN:16.0,svN:31.9,form:40.6,exp:37.6,coach:50,xg:1.355,xgc:0.973,formN:34.9,formScore:-0.115},
  "Ghana":{elo:1510,eloN:13.8,svN:62.4,form:35.4,exp:31.2,coach:40,xg:1.423,xgc:1.074,formN:43.6,formScore:-0.068},
  "Curacao":{elo:1434,eloN:4.2,svN:25.6,form:34.8,exp:11.3,coach:50,xg:1.719,xgc:1.394,formN:45.6,formScore:-0.056},
  "Qatar":{elo:1421,eloN:2.6,svN:0.0,form:22.2,exp:57.4,coach:66,xg:0.637,xgc:1.533,formN:7.7,formScore:-0.262}
};

// Raw per-country source inputs (for the in-app source center; same numbers the model uses)
const SOURCE_INPUTS={
  "Spain":{elo:2155,sv:861,xg:2.909,xgc:0.879,exp:67.5,coach:72,f12:72.2,fq:88.9},
  "Argentina":{elo:2114,sv:820,xg:2.141,xgc:0.346,exp:100.0,coach:96,f12:86.1,fq:70.4},
  "France":{elo:2062,sv:1240,xg:2.485,xgc:0.965,exp:89.6,coach:90,f12:77.8,fq:88.9},
  "England":{elo:2021,sv:1345,xg:2.394,xgc:0.24,exp:87.8,coach:88,f12:77.8,fq:100.0},
  "Brazil":{elo:1991,sv:1135,xg:1.898,xgc:0.784,exp:75.9,coach:98,f12:63.9,fq:51.9},
  "Portugal":{elo:1986,sv:1000,xg:2.909,xgc:1.137,exp:60.4,coach:70,f12:75.0,fq:72.2},
  "Colombia":{elo:1977,sv:430,xg:2.201,xgc:1.08,exp:64.8,coach:46,f12:61.1,fq:51.9},
  "Netherlands":{elo:1944,sv:700,xg:2.886,xgc:0.733,exp:45.2,coach:68,f12:69.4,fq:83.3},
  "Ecuador":{elo:1938,sv:236,xg:0.635,xgc:0.324,exp:40.7,coach:38,f12:50.0,fq:59.3},
  "Germany":{elo:1932,sv:850,xg:2.44,xgc:0.834,exp:46.5,coach:74,f12:75.0,fq:83.3},
  "Norway":{elo:1914,sv:580,xg:3.654,xgc:0.738,exp:0.0,coach:44,f12:80.6,fq:100.0},
  "Croatia":{elo:1911,sv:326,xg:2.541,xgc:0.862,exp:70.6,coach:66,f12:69.4,fq:91.7},
  "Turkey":{elo:1911,sv:520,xg:2.283,xgc:1.144,exp:23.8,coach:50,f12:77.8,fq:79.2},
  "Japan":{elo:1906,sv:285,xg:1.648,xgc:0.478,exp:49.1,coach:46,f12:66.7,fq:84.4},
  "Belgium":{elo:1893,sv:549,xg:3.565,xgc:0.807,exp:57.7,coach:74,f12:77.8,fq:75.0},
  "Uruguay":{elo:1892,sv:424,xg:0.843,xgc:0.697,exp:61.7,coach:82,f12:47.2,fq:51.9},
  "Switzerland":{elo:1891,sv:282,xg:2.268,xgc:0.667,exp:52.4,coach:48,f12:69.4,fq:77.8},
  "Mexico":{elo:1915,sv:165,xg:1.528,xgc:0.61,exp:74.8,coach:64,f12:61.1,fq:75.0},
  "Senegal":{elo:1867,sv:470,xg:1.983,xgc:0.847,exp:74.0,coach:50,f12:69.4,fq:80.0},
  "Paraguay":{elo:1833,sv:95,xg:1.213,xgc:0.811,exp:29.4,coach:54,f12:50.0,fq:51.9},
  "Austria":{elo:1830,sv:340,xg:2.46,xgc:0.59,exp:23.0,coach:76,f12:77.8,fq:79.2},
  "Morocco":{elo:1827,sv:460,xg:2.11,xgc:0.345,exp:76.8,coach:58,f12:83.3,fq:100.0},
  "Canada":{elo:1838,sv:185,xg:1.187,xgc:0.444,exp:56.0,coach:52,f12:58.3,fq:75.0},
  "Scotland":{elo:1782,sv:210,xg:2.255,xgc:1.13,exp:13.2,coach:44,f12:61.1,fq:72.2},
  "Australia":{elo:1777,sv:41,xg:1.614,xgc:0.778,exp:36.2,coach:42,f12:61.1,fq:77.1},
  "Iran":{elo:1772,sv:51,xg:1.588,xgc:0.582,exp:38.2,coach:40,f12:58.3,fq:77.1},
  "Algeria":{elo:1760,sv:260,xg:1.883,xgc:0.49,exp:36.9,coach:56,f12:75.0,fq:83.3},
  "South Korea":{elo:1758,sv:184,xg:1.837,xgc:0.819,exp:39.8,coach:48,f12:69.4,fq:79.2},
  "Czechia":{elo:1740,sv:0,xg:2.178,xgc:1.21,exp:22.2,coach:40,f12:61.1,fq:60.0},
  "Panama":{elo:1730,sv:40,xg:1.751,xgc:1.285,exp:49.3,coach:40,f12:55.6,fq:80.0},
  "United States":{elo:1876,sv:270,xg:1.624,xgc:1.572,exp:73.0,coach:78,f12:52.8,fq:75.0},
  "Uzbekistan":{elo:1718,sv:70,xg:1.314,xgc:0.593,exp:16.0,coach:64,f12:55.6,fq:72.9},
  "Sweden":{elo:1712,sv:430,xg:1.47,xgc:1.851,exp:23.6,coach:44,f12:41.7,fq:33.3},
  "Egypt":{elo:1696,sv:120,xg:1.186,xgc:0.811,exp:57.6,coach:42,f12:58.3,fq:86.7},
  "Ivory Coast":{elo:1695,sv:410,xg:2.454,xgc:0.773,exp:47.3,coach:48,f12:77.8,fq:86.7},
  "Jordan":{elo:1685,sv:35,xg:1.874,xgc:1.507,exp:24.0,coach:40,f12:47.2,fq:60.4},
  "DR Congo":{elo:1661,sv:150,xg:1.153,xgc:0.462,exp:40.0,coach:42,f12:66.7,fq:74.4},
  "Tunisia":{elo:1628,sv:54,xg:1.322,xgc:1.327,exp:57.1,coach:38,f12:38.9,fq:93.3},
  "Iraq":{elo:1618,sv:35,xg:1.109,xgc:0.732,exp:13.3,coach:30,f12:66.7,fq:69.8},
  "Bosnia-Herzegovina":{elo:1595,sv:180,xg:1.816,xgc:0.986,exp:0.0,coach:36,f12:50.0,fq:63.3},
  "Cape Verde":{elo:1578,sv:90,xg:1.623,xgc:1.184,exp:17.7,coach:30,f12:55.6,fq:76.7},
  "Saudi Arabia":{elo:1569,sv:15,xg:1.147,xgc:1.131,exp:34.5,coach:72,f12:44.4,fq:55.6},
  "New Zealand":{elo:1562,sv:35,xg:0.906,xgc:1.601,exp:0.0,coach:34,f12:19.4,fq:100.0},
  "Haiti":{elo:1548,sv:40,xg:1.436,xgc:1.071,exp:21.3,coach:40,f12:44.4,fq:66.7},
  "South Africa":{elo:1528,sv:60,xg:1.355,xgc:0.973,exp:37.6,coach:50,f12:52.8,fq:60.0},
  "Ghana":{elo:1510,sv:242,xg:1.423,xgc:1.074,exp:31.2,coach:40,f12:38.9,fq:83.3},
  "Curacao":{elo:1434,sv:45,xg:1.719,xgc:1.394,exp:11.3,coach:50,f12:44.4,fq:80.0},
  "Qatar":{elo:1421,sv:14,xg:0.637,xgc:1.533,exp:57.4,coach:66,f12:22.2,fq:61.1}
};
...
function ModelViz(){
  ...
  const FACTORS=[
    ...
    {key:"coach",pct:5,
     ...
     formula:lang==="nl"?"Inschatting: club-/competitieniveau + prijzen":"Estimate: club/competition level + honours",
     intro:lang==="nl"?"Een bewezen coach scherpt keuzes onder druk.":"A proven coach sharpens decisions under pressure.",
     detail:lang==="nl"
       ?"Een inschatting per bondscoach op basis van het niveau van de clubs en competities waar hij werkte en de prijzen die hij won. Dit is een beoordeling, geen harde meting — de onderbouwing per coach staat bij de databronnen. Ancelotti en Scaloni scoren het hoogst."
       :"An estimate per head coach based on the level of clubs and competitions they worked in and the trophies they won. This is a judgement, not a hard measurement — the basis per coach is listed under data sources. Ancelotti and Scaloni score highest."},
    {key:"trend",pct:10,
  ...
  const TITLE_PCT={"Spain":42.1,"Argentina":29.2,"France":15.6,"England":9.8,"Portugal":1.2,"Brazil":1.2,"Germany":0.3,"Netherlands":0.3};
            ...
            <React.Fragment>
              ...
              <div style={{background:T.card,border:`1px solid ${T.border}`,borderRadius:6,
                ...
                {[
                  ...
                  {label:"Coach",src:lang==="nl"?"Inschatting":"Estimate",desc:{nl:"Beoordeling per bondscoach op club-/competitieniveau en gewonnen prijzen; onderbouwing vastgelegd",en:"Judgement per head coach on club/competition level and trophies won; basis documented"}},
